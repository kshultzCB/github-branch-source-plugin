...
public class SCMFileSystemBenchmark {
    ...
    public SCMFileSystemBenchmark(String revision) {
    ...
    public void rootIsADirectory() throws Exception {
        ...
        assertThat(fs.getRoot().getType(), Matchers.is(SCMFile.Type.DIRECTORY));
    ...
    public void listFilesInRoot() throws Exception {
        SCMFileSystem fs = SCMFileSystem.of(source, master, revision);
        assertThat(fs.getRoot().children(), hasItem(Matchers.<SCMFile>hasProperty("name", Matchers.is("README.md"))));
    }

    @Test
    public void readmeIsAFile() throws Exception {
        SCMFileSystem fs = SCMFileSystem.of(source, master, revision);
        assertThat(fs.getRoot().child("README.md").getType(), Matchers.is(SCMFile.Type.REGULAR_FILE));
    }
    ...
    public void readFileFromDir() throws Exception {
        ...
        assumeThat(((AbstractGitSCMSource.SCMRevisionImpl) revision).getHash(),
                Matchers.is("c0e024f89969b976da165eecaa71e09dc60c3da1"));
        SCMFileSystem fs = SCMFileSystem.of(source, master, revision);
        ...
        assertThat(fs.getRoot().child("fu/bar.txt").contentAsString(), Matchers.is(expected));
    }
    ...
    public void resolveDir() throws Exception {
        ...
        assumeThat(((AbstractGitSCMSource.SCMRevisionImpl) revision).getHash(),
                Matchers.is("c0e024f89969b976da165eecaa71e09dc60c3da1"));
        SCMFileSystem fs = SCMFileSystem.of(source, master, revision);
        assertThat(fs.getRoot().child("fu").getType(), Matchers.is(SCMFile.Type.DIRECTORY));
    }
    ...
    public void listDir() throws Exception {
        ...
        assertThat(fs.getRoot().child("fu").children(),
                hasItem(Matchers.<SCMFile>hasProperty("name", Matchers.is("manchu.txt"))));
    }
    ...
    public void resolveDirPRHead() throws Exception {
        ...
        assertThat(prHeadRevision.isMerge(), Matchers.is(false));
    ...
    public void resolveDirPRMerge() throws Exception {
        ...
        assertThat(prMergeRevision.isMerge(), Matchers.is(true));
    ...
    public void resolveDirPRInvalidMerge() throws Exception {
        ...
        assertThat(prMergeInvalidRevision.isMerge(), Matchers.is(true));
    ...
    public void resolveDirPRNotMergeable() throws Exception {
        ...
        assertThat(prMergeNotMergeableRevision.isMerge(), Matchers.is(true));
